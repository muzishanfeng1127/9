...
def rpsls(player_choice):
    ...
    if player_choice_number==0 and comp_number==1:
         return (print("机器赢了"))
    ...
    if player_choice_number==1 and comp_number==0:
         return(print("您赢了"))
    if player_choice_number==1 and comp_number==2:
        return(print("机器赢了"))
    ...
    if player_choice_number==2 and comp_number==0:
        return(print("您赢了"))
    if player_choice_number==2 and comp_number==1:
        return(print("您赢了"))
    if player_choice_number==2 and comp_number==3:
        return(print("机器赢了"))
    ...
    if player_choice_number==3 and comp_number==1:
        return(print("您赢了"))
    if player_choice_number==3 and comp_number==2:
        return(print("您赢了"))
    if player_choice_number==3 and comp_number==4:
        return(print("机器赢了"))
    if player_choice_number==4 and comp_number==0:
        return(print("机器赢了"))
    if player_choice_number==4 and comp_number==1:
        return(print("机器赢了"))
